...
export default function OrganizationsPage() {
  ...
  const [scrapeDataStatesLoaded, setScrapeDataStatesLoaded] = useState(false)
  ...
  useEffect(() => {
    listScrapeDataStates()
      .then((payload) => {
        ...
        setScrapeDataStatesLoaded(true)
        setScrapeDataStatesError('')
      })
      .catch((err) => {
        setScrapeDataStates([])
        setScrapeDataStatesLoaded(false)
  ...
  async function handleSaveOrganization(event) {
    ...
    if (scrapeDataStatesLoaded) {
      ...
      parsedSettings.leafly_states = Array.isArray(editForm.scrape_states) ? editForm.scrape_states : []
    }
